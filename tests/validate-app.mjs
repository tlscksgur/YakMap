...
const assertions = [
  ...
  ["app runs OCR when image is selected", contents["app.js"].includes('#ocrImage")?.addEventListener("change"') && contents["app.js"].includes("OCR 추출 중입니다")],
  ...
  ["app handles cancelled OCR image selection", contents["app.js"].includes("이미지 선택이 취소되었습니다.")],
