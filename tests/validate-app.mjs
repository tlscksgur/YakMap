...
const assertions = [
  ...
  ["app scores Kakao-to-public operating-hours matches by phone and address tokens", contents["app.js"].includes("kakaoPublicStoreMatchScore") && contents["app.js"].includes("normalizePhone") && contents["app.js"].includes("addressTokenScore")],
